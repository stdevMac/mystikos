...
static const oe_ecall_info_t _tlssrv_ecall_info_table[] = 
{
    { "setup_tls_server" },
    { "oe_log_init_ecall" },
...
oe_result_t tlssrv_setup_tls_server(
    ...
    const char* port)
{
    ...
    _args.port_len = (port) ? (oe_strlen(port) + 1) : 0;

    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(setup_tls_server_args_t));
    if (port)
        OE_ADD_ARG_SIZE(_input_buffer_size, _args.port_len, sizeof(char));
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _tlssrv_ecall_info_table[tlssrv_fcn_id_setup_tls_server].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
OE_WEAK_ALIAS(tlssrv_setup_tls_server, setup_tls_server);

oe_result_t tlssrv_oe_log_init_ecall(
    oe_enclave_t* enclave,
    ...
    uint32_t log_level)
{
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _tlssrv_ecall_info_table[tlssrv_fcn_id_oe_log_init_ecall].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
OE_WEAK_ALIAS(tlssrv_oe_log_init_ecall, oe_log_init_ecall);

oe_result_t tlssrv_oe_get_sgx_report_ecall(
    oe_enclave_t* enclave,
    oe_result_t* _retval,
    ...
    sgx_report_t* report)
{
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _tlssrv_ecall_info_table[tlssrv_fcn_id_oe_get_sgx_report_ecall].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
OE_WEAK_ALIAS(tlssrv_oe_get_sgx_report_ecall, oe_get_sgx_report_ecall);

oe_result_t tlssrv_oe_get_report_v2_ecall(
    oe_enclave_t* enclave,
    oe_result_t* _retval,
    uint32_t flags,
    const void* opt_params,
    ...
    size_t* report_buffer_size)
{
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _tlssrv_ecall_info_table[tlssrv_fcn_id_oe_get_report_v2_ecall].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
OE_WEAK_ALIAS(tlssrv_oe_get_report_v2_ecall, oe_get_report_v2_ecall);

oe_result_t tlssrv_oe_verify_local_report_ecall(
    oe_enclave_t* enclave,
    oe_result_t* _retval,
    ...
    oe_report_t* parsed_report)
{
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _tlssrv_ecall_info_table[tlssrv_fcn_id_oe_verify_local_report_ecall].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
OE_WEAK_ALIAS(tlssrv_oe_verify_local_report_ecall, oe_verify_local_report_ecall);

oe_result_t tlssrv_oe_sgx_init_context_switchless_ecall(
    oe_enclave_t* enclave,
    oe_result_t* _retval,
    oe_host_worker_context_t* host_worker_contexts,
    uint64_t num_host_workers)
{
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _tlssrv_ecall_info_table[tlssrv_fcn_id_oe_sgx_init_context_switchless_ecall].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
OE_WEAK_ALIAS(tlssrv_oe_sgx_init_context_switchless_ecall, oe_sgx_init_context_switchless_ecall);

oe_result_t tlssrv_oe_sgx_switchless_enclave_worker_thread_ecall(
    oe_enclave_t* enclave,
    oe_enclave_worker_context_t* context)
{
    oe_result_t _result = OE_FAILURE;
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _tlssrv_ecall_info_table[tlssrv_fcn_id_oe_sgx_switchless_enclave_worker_thread_ecall].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
OE_WEAK_ALIAS(tlssrv_oe_sgx_switchless_enclave_worker_thread_ecall, oe_sgx_switchless_enclave_worker_thread_ecall);
...
static oe_ocall_func_t _tlssrv_ocall_function_table[] = {
...
oe_result_t oe_create_tlssrv_enclave(
    const char* path,
    ...
    oe_enclave_t** enclave)
{
    return oe_create_enclave(
               ...
               settings,
               setting_count,
               _tlssrv_ocall_function_table,
               86,
               _tlssrv_ecall_info_table,
                7,
               enclave);
}
